...
public class HomeWork3 {
	...
	double sum = totalProduct1+totalProduct2+totalProduct3+totalProduct4+totalProduct5+totalProduct6+totalProduct7+totalProduct8;
	double tax = (sum * salesTaxPercentage) / 100;
	double payment = sum + tax;
	System.out.println("************1234");
	System.out.println("    Ext MC                       " +String.format("%.2f", payment));
	System.out.println("    Subtotal                     " +String.format("%.2f", sum));// here I use addition concept
